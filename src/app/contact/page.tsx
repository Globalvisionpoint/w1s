        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mt-4">
              Completează formularul de mai jos sau scrie-ne pe <a href="https://wa.me/40758653550" target="_blank" rel="noopener noreferrer" className="font-bold" style={{ color: '#25D366' }}>WhatsApp</a> și te vom contacta în cel mai scurt timp pentru a discuta despre proiectul tău.
            </p>
          </div>
